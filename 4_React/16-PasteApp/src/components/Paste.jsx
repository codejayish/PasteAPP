...
const Paste = () => {
  const pastes = useSelector((state) => state.paste.pastes); //here, "paste" is the name of slice and "pastes" is the storage place
  ...
  );  //if the searched item is found in the paste slice data then it shows that
